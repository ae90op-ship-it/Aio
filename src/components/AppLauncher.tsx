          ...
          >
            <div className="max-w-6xl mx-auto">
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-3xl font-semibold text-neutral-900 dark:text-white">{t.menu}</h2>
                <button
                  onClick={onClose}
              ...
              <div className="space-y-12 pb-20">
                {categories.map((category, catIdx) => (
                  <motion.div
                    ...
                    key={category}
                  >
                    <h3 className="text-sm font-semibold text-blue-600 dark:text-blue-400 mb-6 uppercase tracking-wider">
                      {t.categories[category]}
                    </h3>
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-6 sm:gap-8">
                      {APPS.filter((app) => app.category === category).map(
                        (app, idx) => {
